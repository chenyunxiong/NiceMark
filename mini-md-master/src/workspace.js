(function () {
    ...
    var workPath = path.join(app.getPath("appData"), 'NiceMark');
    var cachePath = path.join(workPath, "workspace.json");
    ...
    workspaceMenu.append(new MenuItem({
        label: '添加本地目录',
        click: showAddLocalFolderDialog
    }));
